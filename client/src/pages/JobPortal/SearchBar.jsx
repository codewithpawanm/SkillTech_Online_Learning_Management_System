    ...
    return (
        <div className="flex flex-wrap gap-4 my-10 justify-center px-4 sm:px-10">
            <select 
                ...
                className="w-full sm:w-64 py-3 px-4 bg-gray-100 text-gray-700 font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
            >
                <option value="" disabled hidden>Job Role</option>
                <option value="iOS Developer">iOS Developer</option>
                <option value="Frontend Developer">Frontend Developer</option>
            ...
            <button 
                onClick={search} 
                className="w-full sm:w-64 bg-blue-600 text-white font-bold py-3 rounded-md shadow-md hover:bg-blue-700 transition-all duration-300 focus:outline-none"
            >
                Search
            </button>
        </div>
